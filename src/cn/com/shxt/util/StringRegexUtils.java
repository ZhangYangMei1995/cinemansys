...
public class StringRegexUtils {
	...
	/*public static void main(String[] args) {
		// 匹配图象 defult.jpg
		// String image = "defult.jpg";
		// System.out.println(isRegexpValidate(image,
		// StringRegexUtils.icon_regexp));

		// java.util.regex
		// java.util.regex 包主要由三个类所组成：Pattern、Matcher 和 PatternSyntaxException

		// System.out.println(isRegexpValidate("1234567890",
		// StringRegexUtils.ID_card_regexp));

		// System.out.println(isRegexpValidate("abcd", "abc."));

		String str = "paladinzhl00@qq.com";
		System.out
				.println(isRegexpValidate(str, StringRegexUtils.email_regexp));
